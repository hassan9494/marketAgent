...
.accordion-service .card .collapse.show {
color: #222;
}
...
.accordion-service .card .card-header {
border: 0;
box-shadow: none;
border-radius: 2px;
padding: 0;
...
.accordion-service .card .card-header .btn-header-link {
display: block;
text-align: left;
color: #000;
background: #fff;
...
.accordion-service .card .card-header .btn-header-link:after {
content: "\f107";
...
.accordion-service .card .card-header .btn-header-link.collapsed:after {
content: "\f106";
}

.accordion-service .card .collapsing {
}

.accordion-service .card .collapse {
border: 0;
}
