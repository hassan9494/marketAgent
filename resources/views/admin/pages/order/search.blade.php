                ...
                @forelse($orders as $order)
                    <tr>
                        <td class="text-center">
                            <input type="checkbox" id="chk-{{ $order->id }}" class="form-check-input row-tic tic-check"
                        ...
                        <td data-label="@lang('Order Details')">
                            <h5>{{ optional($order->service)->service_title }}</h5>
                        ...
                        <td data-label="@lang('Status')">
                            ...
                            @if($order->status=='awaiting')
                                <span class="badge badge-pill badge-danger">{{'Awaiting'}}</span>
...
{{--                                    </a>--}}
{{--                                    <a href="javascript:void(0)" class="dropdown-item status-change" data-toggle="modal" data-target="#statusMoldal" data-route="{{ route('admin.order.status.change',['id'=>$order->id] ) }} " >--}}
{{--                                        <i class="fa fa-check pr-2 text-success" aria-hidden="true"></i> @lang('Change Status')--}}
{{--                                    </a>--}}
