...
@section('content')
    <div class="row">
        ...
        <div class="card  card-form m-0 m-md-4 my-4 m-md-0 shadow">
            ...
            <div class="card-body">
                <form action="{{ route('admin.sms.config') }}" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="actionMethod" id="actionMethod" class="form-control  @error('actionMethod') is-invalid @enderror">
                                    <option value="GET" {{ (old('actionMethod',$smsControl->actionMethod) == 'GET') ? 'selected' : '' }}>GET</option>
                                    <option value="POST" {{ (old('actionMethod',$smsControl->actionMethod) == 'POST') ? 'selected' : '' }} >POST</option>
                                </select>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="actionUrl" value="{{ old('actionUrl',$smsControl->actionUrl) }}" placeholder="@lang('Enter request URL')"
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link {{ ($headerActive) ? 'active' : '' }}" id="headerData-tab" data-toggle="tab" href="#headerData" role="tab" aria-controls="headerData"
                               aria-selected="{{ ($headerActive) ? 'true' : 'false' }}">@lang('Headers')</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ ($paramActive) ? 'active' : '' }}" id="params-tab" data-toggle="tab" href="#params" role="tab" aria-controls="params"
                               aria-selected="{{ ($paramActive) ? 'true' : 'false' }}">@lang('Params')</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ ($formActive) ? 'active' : '' }}" id="formData-tab" data-toggle="tab" href="#formData" role="tab" aria-controls="contact"
                               aria-selected="{{ ($formActive) ? 'true' : 'false' }}">@lang('Form Data')</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">

                        <div class="mt-2 tab-pane fade {{ ($headerActive) ? 'show active' : '' }}" id="headerData" role="tabpanel" aria-labelledby="headerData-tab">
                            ...
                            <div class="headerDataWrapper mt-2">
                                @if(is_null($headerData))
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input type="text" name="headerDataKeys[]" value="" placeholder="@lang('Key')" class="form-control  headerDataKeys">
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                <input type="text" name="headerDataValues[]" value="" placeholder="@lang('Value')" class="form-control ">
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <a href="javascript:void(0);" class="btn btn-primary btn-sm addHeaderData"><i class="fas fa-plus"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                @else
                                    @foreach(json_decode($headerData) as $key => $value)
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <input type="text" name="headerDataKeys[]" value="{{$key}}" placeholder="@lang('Key')" autocomplete="off"
                                                           class="form-control  headerDataKeys @error("headerDataKeys.$loop->index") is-invalid @enderror">
                                                    <div class="invalid-feedback">@error("headerDataKeys.$loop->index") @lang($message) @enderror</div>
                                                </div>
                                            </div>
                                            <div class="col-md-7">
                                                <div class="form-group">
                                                    <input type="text" name="headerDataValues[]" value="{{$value}}" placeholder="@lang('Value')"
                                                           class="form-control  @error("headerDataValues.$loop->index") is-invalid @enderror">
                                                    <div class="invalid-feedback">@error("headerDataValues.$loop->index") @lang($message) @enderror</div>
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                        ...
                        <div class="tab-pane fade {{ ($paramActive) ? 'show active' : '' }}" id="params" role="tabpanel" aria-labelledby="params-tab">
                            ...
                            <div class="paramsWrapper mt-2 ">
                                @if(is_null($paramData))
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <a href="javascript:void(0);" class="btn btn-primary btn-sm addParams"><i class="fas fa-plus"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                @else
                                    @foreach(json_decode($paramData) as $key => $value)
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <input type="text" name="paramKeys[]" value="{{ $key }}" placeholder="@lang('Key')"
                                                           class="form-control  @error("paramKeys.$loop->index") is-invalid @enderror">
                                                    <div class="invalid-feedback">@error("paramKeys.$loop->index") @lang($message) @enderror</div>
                                                </div>
                                            </div>
                                            <div class="col-md-7">
                                                <div class="form-group">
                                                    <input type="text" name="paramValues[]" value="{{ $value }}" placeholder="@lang('Value')"
                                                           class="form-control  @error("paramValues.$loop->index") is-invalid @enderror">
                                                    <div class="invalid-feedback">@error("paramValues.$loop->index") @lang($message) @enderror</div>
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                        ...
                        <div class="tab-pane fade{{ ($formActive) ? 'show active' : '' }}" id="formData" role="tabpanel" aria-labelledby="formData-tab">
                            ...
                            <div class="formDataWrapper mt-2">
                                @if(is_null($formData))
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                <input type="text" name="formDataValues[]" value="" placeholder="@lang('Value')" class="form-control ">
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <a href="javascript:void(0);" class="btn btn-primary btn-sm addFormData"><i class="fas fa-plus"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                @else
                                    @foreach(json_decode($formData) as $key => $value)
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <input type="text" name="formDataKeys[]" value="{{ $key }}" placeholder="@lang('Key')"
                                                           class="form-control  @error("formDataKeys.$loop->index") is-invalid @enderror">
                                                    <div class="invalid-feedback">@error("formDataKeys.$loop->index") @lang($message) @enderror</div>
                                                </div>
                                            </div>
                                            <div class="col-md-7">
                                                <div class="form-group">
                                                    <input type="text" name="formDataValues[]" value="{{ $value }}" placeholder="@lang('Value')"
                                                           class="form-control  @error("formDataValues.$loop->index") is-invalid @enderror">
                                                    <div class="invalid-feedback">@error("formDataValues.$loop->index") @lang($message) @enderror</div>
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                    ...
                    <button type="submit" class="btn w-100 btn-primary btn-block mt-3">@lang('Save Changes')</button>
                </form>
            </div>
        </div>
